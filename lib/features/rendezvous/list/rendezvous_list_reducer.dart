...
RendezvousListState rendezvousListReducer(RendezvousListState current, dynamic action) {
  ...
  if (action is RendezvousListSuccessAction) {
    return current.copyWith(
      futurRendezVousStatus: action.period == RendezvousPeriod.FUTUR ? RendezvousListStatus.SUCCESS : null,
      pastRendezVousStatus: action.period == RendezvousPeriod.PASSE ? RendezvousListStatus.SUCCESS : null,
      rendezvous: action.rendezvousListResult.rendezvous + current.rendezvous,
      sessionsMilo: action.sessionsMilo + current.sessionsMilo,
