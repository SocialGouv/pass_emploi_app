...
UserActionPEListState userActionPEListReducer(UserActionPEListState current, dynamic action) {
  if (action is UserActionPEListLoadingAction) {
    return UserActionPEListLoadingState();
  }
  if (action is UserActionPEListFailureAction) {
    return UserActionPEListFailureState();
  }
