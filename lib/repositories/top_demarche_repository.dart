    ...
    return [
      DemarcheDuReferentiel(
        ...
        comments: [
          ...
          Comment(label: 'Moyen à définir', code: 'C15.06'),
        ],
      ...
      DemarcheDuReferentiel(
        ...
        comments: [
          ...
          Comment(label: 'Moyen à définir', code: 'C17.05'),
        ],
        isCommentMandatory: true,
      ),
      DemarcheDuReferentiel(
        ...
        comments: [
          ...
          Comment(label: 'Moyen à définir', code: 'C18.04'),
        ],
        isCommentMandatory: true,
      ),
      DemarcheDuReferentiel(
      ...
      DemarcheDuReferentiel(
        ...
        comments: [
          ...
          Comment(label: 'Moyen à définir', code: 'C12.07'),
        ],
        isCommentMandatory: true,
      ),
      DemarcheDuReferentiel(
      ...
      DemarcheDuReferentiel(
        ...
        comments: [
          ...
          Comment(label: 'Moyen à définir', code: 'C02.05'),
        ],
        isCommentMandatory: true,
      ),
      DemarcheDuReferentiel(
        ...
        comments: [
          ...
          Comment(label: 'Moyen à définir', code: 'C11.07'),
        ],
        isCommentMandatory: true,
      ),
      DemarcheDuReferentiel(
        ...
        comments: [
          ...
          Comment(label: 'Moyen à définir', code: 'C01.06'),
        ],
        isCommentMandatory: true,
      ),
      DemarcheDuReferentiel(
        ...
        comments: [
          ...
          Comment(label: 'Moyen à définir', code: 'C20.03'),
        ],
        isCommentMandatory: true,
      ),
    ];
