...
class MainPageViewModel extends Equatable {
  ...
  MainPageViewModel({required this.withChatBadge, required this.isPoleEmploiLogin, required this.showRating});
  ...
  @override
  List<Object?> get props => [withChatBadge, isPoleEmploiLogin, showRating];
}
