...
extension on EventType {
  String serialized() {
    return switch (this) {
      ...
      EventType.PIECE_JOINTE_BENEFICIAIRE_TELECHARGEE => "PIECE_JOINTE_BENEFICIAIRE_TELECHARGEE",
      EventType.PIECE_JOINTE_CONSEILLER_TELECHARGEE => "PIECE_JOINTE_CONSEILLER_TELECHARGEE",
      ...
      EventType.MESSAGE_ENVOYE_PJ => 'MESSAGE_ENVOYE_PJ',
    };
  }
}
