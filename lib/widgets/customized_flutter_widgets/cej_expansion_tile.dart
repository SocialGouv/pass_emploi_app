// Entire file is copied-pasted from Flutter SDK JUST to close expansion with animation programmatically.
...
/// [CejExpansionTile] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
...
/// to the [leading] and [trailing] properties of [CejExpansionTile].
///
/// {@tool dartpad}
...
class CejExpansionTile extends StatefulWidget {
  /// Creates a single-line [ListTile] with an expansion arrow icon that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const CejExpansionTile({
    super.key,
    this.leading,
    required this.title,
    this.subtitle,
  ...
  @override
  State<CejExpansionTile> createState() => CejExpansionTileState();
}

class CejExpansionTileState extends State<CejExpansionTile> with SingleTickerProviderStateMixin {
  ...
  /// Original Flutter class is copied-pasted just for this method
  void closeExpansion() {
