class Strings {
  ...
  static String alreadyHaveAccount =
      "Vous avez déjà un compte sur cette application ?";
  ...
  static String whyThisAppDesc =
      "C’est l’application dédiée aux bénéficiaires du Contrat Engagement Jeune (CEJ)";
  static String customService = "Un suivi personnalisé";
  static String customServiceDesc =
      "Suivez toutes vos actions en lien avec vos démarches professionnelles.";
  static String favoredContact = "Un moyen de contact privilégié";
  static String favoredContactDesc =
  ...
  static String searchToolDesc =
      "Recherchez un emploi, gérez vos offres favorites et trouvez des solutions.";
  ...
  static String mandatoryAccessCodeError =
      "Votre code d'accès doit être renseigné";
  ...
  static String rendezVousError =
      "Erreur lors de la récupération de vos rendez-vous";
  ...
  static String noRendezVousCetteSemaineTitre =
      "Vous n'avez pas encore de rendez-vous prévus cette semaine";
  static String noRendezYet = "Vous n'avez pas encore de rendez-vous prévus";
  static String noMoreRendezVousThisWeek =
      "Vous n'avez pas d'autres rendez-vous prévus cette semaine.";
  static String noRendezYetSubtitle =
      "Vous pouvez consulter ceux passés et à venir en utilisant les flèches en haut de page.";
  static String noRendezAutreCetteSemainePrefix =
      "Vous n’avez pas encore de rendez-vous prévus pour la semaine du ";
  static String noRendezAvantCetteSemaine =
      "Vous n’avez pas encore de rendez-vous passés";
  static String noRendezVousFutur =
  ...
  static String rendezvousModalityCardMessage(
          String modality, String conseiller) =>
  ...
  static String jobLocationHint =
      "Saisissez une ville, un département ou une région";
  ...
  static String immersionLabel =
      "Découvrez un métier en immersion dans une entreprise.";
  ...
  static String immersionError =
      "Erreur lors de la récupération de l'offre d'immersion. Veuillez réessayer";
  ...
  static String immersionVolontaireExplanation =
      "Cette entreprise recherche activement des candidats à l’immersion.";
  ...
  static String serviceCiviqueUrl =
  ...
  static String knowMoreAboutServiceCivique =
  ...
  static String knowMoreAboutServiceCiviqueThirdTitle =
  ...
  static String mandatorySuppressionLabelError =
      "Vérifiez que vous avez bien tapé “supprimer”";
  ...
  static String mandatorySavedSearchTitleError =
  ...
  static String savedSearchInfo =
      "Les filtres appliqués seront aussi enregistrés.";
  ...
  static String savedSearchTitleField(metier, localisation) =>
      "$metier - $localisation";
  ...
  static String creationSavedSearchError =
      "Erreur lors de la création de la recherche sauvegardée. Veuillez réessayer";
  static String savedSearchGetError =
  ...
  static String savedSearchDeleteMessage =
      "Voulez-vous vraiment supprimer la recherche sauvegardée ?";
  static String cancelLabel = "Annuler";
  static String suppressionLabel = "Supprimer";
  static String savedSearchDeleteError =
      "Erreur lors de la suppression de la recherche.";
  static String savedSearchDeleteSuccess =
      "Votre recherche sauvegardée a été supprimée avec succès.";
