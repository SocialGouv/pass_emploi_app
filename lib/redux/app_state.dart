...
class AppState extends Equatable {
  ...
  final MessageInformatifState messageInformatifState;
  ...
  AppState({
    ...
    required this.messageInformatifState,
  ...
  AppState copyWith({
    ...
    return AppState(
      ...
      messageInformatifState: messageInformatifState ?? this.messageInformatifState,
  ...
  factory AppState.initialState({Configuration? configuration}) {
    return AppState(
      ...
      messageInformatifState: MessageInformatifNotInitializedState(),
