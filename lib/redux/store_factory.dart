...
import 'package:pass_emploi_app/features/raclette/raclette_middleware.dart';
...
class StoreFactory {
  ...
  final RacletteRepository racletteRepository;
  ...
  redux.Store<AppState> initializeReduxStore({required AppState initialState}) {
    return redux.Store<AppState>(
      ...
      middleware: [
        ...
        RacletteMiddleware(racletteRepository),
