...
void main() {
  group('when brand is BRSA...', () {
    test("should not allow deletion or modification", () {
      // Given
      final action = mockUserAction(id: 'actionId', creator: JeuneActionCreator());
      final store = givenBrsaState().withAction(action).actionWithoutComments().store();
      ...
      expect(viewModel.withUpdateOption, isFalse);
    });
  });
  group('when brand is CEJ...', () {
    test(
        "create VM when creator is jeune and action has no comment should create view model properly and autorize delete",
        () {
      // Given
      final action = mockUserAction(id: 'actionId', creator: JeuneActionCreator());
    ...
    test("create VM when status is done should not autorize delete", () {
      // Given
    ...
    test(
        "create VM when creator is jeune and action has comments should create view model properly and not autorize delete",
        () {
      // Given
      final action = mockUserAction(id: 'actionId', creator: JeuneActionCreator());
    ...
    test("create VM when creator is conseiller should create view model properly and not autorize delete", () {
      // Given
    ...
    test("create VM when action is on time should properly set texts, icons and active color", () {
      // Given
    ...
    test("create VM when action is late should properly set texts, icons and warning color", () {
      // Given
    ...
    test("create VM when action is DONE should not display date echeance", () {
      // Given
    ...
    test("create VM when action is CANCELED should not display date echeance", () {
      // Given
    ...
    test("create VM when source is agenda should create view model properly", () {
      // Given
